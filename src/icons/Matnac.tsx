...
export function Matnac(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 342 57" {...props}>
      <title id="title">Matnac</title>
      ...
      <defs>
        ...
        >
          <stop offset="0" />
          <stop offset=".024" stopColor="#191918" />
          <stop offset=".094" stopColor="#464642" />
          <stop offset=".17" stopColor="#797973" />
          <stop offset=".251" stopColor="#96968e" />
          <stop offset=".335" stopColor="#a5a59c" />
          <stop offset=".426" stopColor="#afafa6" />
          <stop offset=".526" stopColor="#bebeb4" />
          <stop offset=".638" stopColor="#c8c8be" />
          <stop offset=".774" stopColor="#dcdcd0" />
          <stop offset="1" stopColor="#e5e5d9" />
        </linearGradient>
        <linearGradient
          id="b"
          x1="6285.148"
        ...
        >
          ...
          <stop offset=".226" stopColor="#dcdcd0" />
          <stop offset=".362" stopColor="#c8c8be" />
          <stop offset=".474" stopColor="#bebeb4" />
          <stop offset=".574" stopColor="#afafa6" />
          <stop offset=".665" stopColor="#a5a59c" />
          <stop offset=".75" stopColor="#96968e" />
          <stop offset=".83" stopColor="#797973" />
          <stop offset=".906" stopColor="#464642" />
          <stop offset=".976" stopColor="#191918" />
          <stop offset="1" />
        </linearGradient>
        <linearGradient
          id="c"
        ...
        >
          <stop offset="0" />
          <stop offset=".074" stopColor="#1b1b1a" />
          <stop offset=".169" stopColor="#585853" />
          <stop offset=".26" stopColor="#8a8a83" />
          <stop offset=".345" stopColor="#b2b2a9" />
          <stop offset=".422" stopColor="#cecec3" />
          <stop offset=".49" stopColor="#dfdfd3" />
          <stop offset=".54" stopColor="#e5e5d9" />
          <stop offset=".586" stopColor="#e0e0d4" />
          <stop offset=".643" stopColor="#d0d0c5" />
          <stop offset=".706" stopColor="#b6b6ac" />
          <stop offset=".773" stopColor="#93938b" />
          <stop offset=".845" stopColor="#ddddd1" />
          <stop offset=".919" stopColor="#2d2d2b" />
        ...
        >
          <stop offset=".216" />
          <stop offset=".235" stopColor="#191918" />
          <stop offset=".29" stopColor="#464642" />
          <stop offset=".35" stopColor="#797973" />
          <stop offset=".412" stopColor="#96968e" />
          <stop offset=".479" stopColor="#a5a59c" />
          <stop offset=".55" stopColor="#afafa6" />
          <stop offset=".628" stopColor="#bebeb4" />
          <stop offset=".716" stopColor="#c8c8be" />
          <stop offset=".823" stopColor="#dcdcd0" />
          <stop offset="1" stopColor="#e5e5d9" />
        </linearGradient>
        <linearGradient
          id="i"
      ...
      <motion.path
        ...
        initial={{ pathLength: 0, opacity: 0, transform: "translateX(calc(50% - 3rem))" }}
      ...
      >
        ...
        <path fill="#e5e5d9" d="M185.2 17.7h-52.6c-8.1 0-14.6-6.4-14.6-14.4h67.1l.1 14.4z" />
